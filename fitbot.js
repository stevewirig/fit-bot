...
//javascript:void(window.open("","disruptive_dtm_debugger","width=600,height=600,location=0,menubar=0,status=1,toolbar=0,resizable=1,scrollbars=1").document.write("<script id=\"disruptive_dtm_debugger\" src=\"https://drive.google.com/file/d/0B1d9kc1oolg4elFrcnVMaVM1UE0/view?usp=sharing\"></"+"script>"));
